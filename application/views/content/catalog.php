		...
		<? foreach ( $Houses as $house ) :?>
			...
			<div style="margin:10px;float:left;">
				<div class="hausdia" style="background-image: url('/typicalprojects_min/<?=$house->link?>/<?=$house->houselink?>/<?=$house->simagepath?>');">
					<a href="/construction/typical_projects/house/<?=$house->id?>">
						<img src="/img/buttons/dot_clear.gif" width="200" height="189" border="0" /></img>
						<br>
						<span style="clear:left"><?=$house->title?></span>
					</a>
				</div>
			</div>
		<? endforeach;?>
